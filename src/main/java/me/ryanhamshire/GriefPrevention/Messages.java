...
public enum Messages
{
    ...
    ClaimTooCloseToOtherClaim("You can't create a claim within {0} blocks of {1}'s claim. Ask them to run /proximitytrust {2} to allow you.", "0: minimum separation distance; 1: nearby claim owner; 2: your name"),
