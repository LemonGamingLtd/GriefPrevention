...
public enum Messages
{
    ...
    RestoreNatureActivate("Ready to restore some nature!  Right click to restore nature, and use /basicclaims to stop."),
    RestoreNatureAggressiveActivate("Aggressive mode activated.  Do NOT use this underneath anything you want to keep!  Right click to aggressively restore nature, and use /basicclaims to stop."),
    FillModeActive("Fill mode activated with radius {0}.  Right click an area to fill.", "0: fill radius"),
    ...
    RestoreNaturePlayerInChunk("Unable to restore.  {0} is in that chunk.", "0: nearby player"),
    ...
    ConfirmFluidRemoval("Abandoning this claim will remove lava inside the claim.  If you're sure, use /abandonclaim again."),
    ...
    UnclaimCleanupWarning("The land you've unclaimed may be changed by other players or cleaned up by administrators.  If you've built something there you want to keep, you should reclaim it."),
